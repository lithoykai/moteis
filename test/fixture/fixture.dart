...
Map<String, dynamic> fakeResponseHttp = {
  "sucesso": true,
  "data": {
    "pagina": 1,
    "qtdPorPagina": 10,
...
Map<String, dynamic> fakeEmptyResponseHttp = {
  "sucesso": true,
  "data": {
    "pagina": 1,
    "qtdPorPagina": 0,
...
ResponseList<Motel> fakeResponseEntity = ResponseList<Motel>(
  sucess: true,
  pageInfo: PageInfoResponse(quantityItens: 1, totalItens: 1, maxPageItens: 1),
  data: [fakeMotel],
);
...
Motel fakeMotel = Motel(
  ...
  suites: [
    Suite(
      ...
      itens: [
        Item(name: "ducha dupla"),
        Item(name: "TV a cabo"),
        Item(name: "TV LED 32''"),
        Item(name: "iluminação por leds"),
        Item(name: "garagem coletiva"),
        Item(name: "som AM/FM"),
        Item(name: "3 canais eróticos"),
        Item(name: "bluetooth"),
        Item(name: "espelho no teto"),
        Item(name: "acesso à suíte via escadas"),
        Item(name: "frigobar"),
        Item(name: "ar-condicionado split"),
        Item(name: "WI-FI"),
        Item(name: "secador de cabelo")
      ],
      categoryItens: [
        Category(
            name: "Frigobar",
      ...
      periods: [
        ...
        Period(
          normalizedTime: "12 horas",
          time: "12",
          price: 129.58,
          totalPrice: 81.58,
          hasCourtesy: false,
          promotion: Promotion(promotion: 48),
        ),
      ],
    ),
  ],
